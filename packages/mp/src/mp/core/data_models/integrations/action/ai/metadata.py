    ...
    parameters_description: Annotated[
        ...
        Field(
            description=(
                ...
                " Create a table that describes the parameters with the following columns:"
                " `Parameter`, `Type`, `Mandatory`, `Description`."
                " The Description column should explain how to use the parameter and how it might affect the action's"
                " flow."
                " If there are no parameters, explicitly mention 'There are no parameters for this action' under this"
                " section."
                " If a parameter is not mandatory but code execution requires it based on the presence of other"
                " parameters,"
                " mention this relationship within its specific row description, or add an optional 'Parameter Notes'"
                " section"
                " below the table (e.g., 'Either this set of parameters or this set of parameters must be configured')."
            ),
        ),
    ]
