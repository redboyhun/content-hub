...
SCRIPT_NAME = "CiscoAMP - UnisolateMachine"
...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            ...
            if computer:
                info = manager.unisolate_machine(computer["connector_guid"])
            ...
            errors += (
                f"Unable to unisolate computer by ip {entity.identifier}: \n{str(e)}\n"
            )
            continue
    ...
    if enriched_entities:
        ...
        output_message = (
            "The following computers unisolated successfully:\n{}\n".format(
                "\n".join(entities_names)
            )
        )
        ...
        output_message = "Cisco AMP - No computers were found to unisolate.\n"
        output_message += errors
