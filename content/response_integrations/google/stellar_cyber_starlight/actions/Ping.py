...
from ..core.StellarCyberStarlightExceptions import StellarCyberInvalidApiKeyError
from ..core.StellarCyberStarlightManager import StellarCyberStarlightManager
from ..core.StellarCyberStarlightConstants import PROVIDER_NAME, PING_SCRIPT_NAME
...
def main():
    ...
    try:
    ...
    except StellarCyberInvalidApiKeyError as e:
        output_message = f"Failed to connect to the Stellar Cyber Starlight server. {e}"
        result = False
        ...
        output_message = (
            f"Failed to connect to the Stellar Cyber Starlight server! Error is {e}"
        )
        result = False
        status = EXECUTION_STATE_FAILED
        siemplify.LOGGER.error(output_message)
