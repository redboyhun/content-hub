...
def main():
    ...
    try:
        ...
        for entity in suitable_entities:
            try:
                ...
                siemplify.LOGGER.info(
                    f"Successfully added tag {tag_name} to {entity.identifier}"
                )
        ...
        if successful_entities:
            output_message += ("Successfully added tag {} to the following endpoints "
                               "from McAfee Mvision ePO V2: \n{}").format(
        ...
        if failed_entities:
            output_message += ("\n\nAction was not able to add tag to the following "
        ...
        result_value = False
        output_message = (
            "Action wasn't able to add tag '{0}'. Reason: Tag '{0}' was not found in "
            "McAfee Mvision ePO. Please check for any spelling mistakes. "
