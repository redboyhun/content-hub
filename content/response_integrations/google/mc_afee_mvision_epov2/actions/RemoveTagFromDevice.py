...
from ..core.exceptions import TagNotFoundException, DeviceNotFoundException
...
def main():
    ...
    try:
        ...
        for entity in suitable_entities:
            try:
                ...
                siemplify.LOGGER.info(
                    f"Successfully removed tag {tag_name} from {entity.identifier}"
                )
        ...
        if successful_entities:
            output_message += ("Successfully removed tag {} from the following "
        ...
        if failed_entities:
            output_message += ("\n\nAction was not able to removed tag from the "
                               "following endpoints from McAfee "
                               "Mvision ePO V2: \n{}\n").format(
        ...
        result_value = False
        output_message = (
            "Action wasn't able to remove tag '{0}'. Reason: Tag '{0}' was not found "
            "in McAfee Mvision ePO. Please check for any spelling mistakes. "
            "In order to get the list of available tags execute "
